...
class GameServiceTest {
	...
	@Test
	void testValidateMove_validCell() {
		assertEquals(true,service.validateMove(currentPlayer, 5));
		
	}
	
	@Test
	void testValidateMove_validCell_greaterCellNumberThan9() {
		assertThrows(CellNotFoundException.class, ()-> service.validateMove(currentPlayer, 10));
	}
	
	@Test
	void testValidateMove_validCell_smallerCellNumberThan9() {
